...
namespace Rhymix\Modules\Bfc_attendance\Models;
...
class Config
{
	...
	public static function getConfig()
	{
		if (self::$_cache === null)
		{
			self::$_cache = ModuleModel::getModuleConfig('bfc_attendance') ?: new \stdClass;
		}
		return self::$_cache;
	}
	...
	public static function setConfig($config)
	{
		...
		$result = $oModuleController->insertModuleConfig('bfc_attendance', $config);
		if ($result->toBool())
		{
			self::$_cache = $config;
		}
